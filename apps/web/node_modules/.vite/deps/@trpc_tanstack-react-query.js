import { r as __toESM$1 } from "./rolldown-runtime-B-1-B7_t.js";
import { t as require_react } from "./react.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { c as infiniteQueryOptions, l as queryOptions, nt as skipToken, q as hashKey } from "./modern-CpeVnWl0.js";
import { A as isObject, D as createRecursiveProxy, E as callProcedure, O as isAsyncIterable, j as run, k as isFunction, s as getUntypedClient, t as TRPCUntypedClient } from "./dist-Bdkq1Qqs.js";
//#region node_modules/@trpc/tanstack-react-query/dist/index.mjs
...
function trpcInfiniteQueryOptions(args) {
	...
	const queryFn = async (queryFnContext) => {
		var _opts$trpc;
		return await query(...getClientArgs(queryKey, (0, import_objectSpread2$4.default)((0, import_objectSpread2$4.default)({}, opts), {}, { trpc: (0, import_objectSpread2$4.default)((0, import_objectSpread2$4.default)({}, opts === null || opts === void 0 ? void 0 : opts.trpc), (opts === null || opts === void 0 || (_opts$trpc = opts.trpc) === null || _opts$trpc === void 0 ? void 0 : _opts$trpc.abortOnUnmount) ? { signal: queryFnContext.signal } : { signal: null }) }), {
...
function trpcMutationOptions(args) {
	var _opts$keyPrefix, _overrides$onSuccess;
	const { mutate, path, prefix, opts, overrides } = args;
	const queryClient = unwrapLazyArg(args.queryClient);
	const mutationKey = getMutationKeyInternal({
		path,
		prefix: (_opts$keyPrefix = opts === null || opts === void 0 ? void 0 : opts.keyPrefix) !== null && _opts$keyPrefix !== void 0 ? _opts$keyPrefix : prefix
	});
	...
	const mutationFn = async (input) => {
		return await mutate(...getClientArgs([...mutationKey, { input }], opts));
	};
...
function useSubscription(opts) {
	...
	const trackedProps = import_react.useRef(/* @__PURE__ */ new Set([]));
	const addTrackedProp = import_react.useCallback((key) => {
		trackedProps.current.add(key);
	}, []);
	const currentSubscriptionRef = import_react.useRef(() => {});
	...
	const resultRef = import_react.useRef(getInitialState());
	const [state, setState] = import_react.useState(trackResult(resultRef, addTrackedProp));
	state.reset = reset;
...
function trackResult(result, onTrackResult) {
	return new Proxy(result.current, { get(_target, prop) {
		onTrackResult(prop);
...
function createTRPCOptionsProxy(opts) {
	...
	const callIt = (type) => {
		return (path, input, trpcOpts) => {
			...
			return (opts.client instanceof TRPCUntypedClient ? opts.client : getUntypedClient(opts.client))[type](path, input, trpcOpts);
		};
	};
...
function createTRPCContext() {
	const TRPCClientContext = import_react.createContext(null);
	const TRPCContext = import_react.createContext(null);
	const TRPCProvider = (props) => {
		const value = import_react.useMemo(() => createTRPCOptionsProxy({
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TRPCClientContext.Provider, {
			value: props.trpcClient,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TRPCContext.Provider, {
				value,
	...
	function useTRPC() {
		const utils = import_react.useContext(TRPCContext);
		if (!utils) throw new Error("useTRPC() can only be used inside of a <TRPCProvider>");
		return utils;
	}
	function useTRPCClient() {
		const client = import_react.useContext(TRPCClientContext);
